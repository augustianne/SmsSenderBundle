...
use Yan\Bundle\SmsSenderBundle\Gateway\EngageSparkPhoneNumberSmsGateway;
 ...
 */
class EngageSparkPhoneNumberSmsGatewayTest extends \PHPUnit_Framework_TestCase
{
    private $sut;
    private $root;
    ...
    {
        return array(
            array(array('status' => 'Success'), true),
            array("", true),
            array(null, true),
            ...
            array(true, true),
            array('test', true),
            array(array('error' => '', 'messageId' => 'MESSAGEID'), false)
        );
    }
    ...
    /**
     * @covers Yan/Bundle/SmsSenderBundle/Gateway/EngageSparkPhoneNumberSmsGateway::getUrl
     */
    public function testGetUrl()
    {
        ...
        $expected = 'https://api.engagespark.com/v1/sms/phonenumber';
        $sut = new EngageSparkPhoneNumberSmsGateway($configurationMock, $curlMock, $smsComposerMock);

        $this->assertEquals($expected, $sut->getUrl());
    }

    /**
     * @covers Yan/Bundle/SmsSenderBundle/Gateway/EngageSparkPhoneNumberSmsGateway::getName
     */
    public function testGetName()
    {
        ...
        $expected = 'ENGAGE_SPARK_PHONE_NUMBER';
        $sut = new EngageSparkPhoneNumberSmsGateway($configurationMock, $curlMock, $smsComposerMock);
    ...
    /**
     * @covers Yan/Bundle/SmsSenderBundle/Gateway/EngageSparkPhoneNumberSmsGateway::getGatewayConfiguration
     */
    ...
    /**
     * @covers Yan/Bundle/SmsSenderBundle/Gateway/EngageSparkPhoneNumberSmsGateway::send
     */
    ...
    public function testSendSuccess()
    {
        ...
        $curlMock->expects($this->any())
            ->method('post')
            ->will($this->returnValue('{"error": "", "messageId": "MESSAGEID"}'));
    ...
    public function testSendThrowsException()
    {
        ...
        $stub = $this->getMockBuilder('\Yan\Bundle\SmsSenderBundle\Gateway\EngageSparkPhoneNumberSmsGateway')
    ...
    /**
     * @covers Yan/Bundle/SmsSenderBundle/Gateway/EngageSparkPhoneNumberSmsGateway::handleResult
    ...
    /**
     * @covers Yan/Bundle/SmsSenderBundle/Gateway/EngageSparkPhoneNumberSmsGateway::getAccountBalance
