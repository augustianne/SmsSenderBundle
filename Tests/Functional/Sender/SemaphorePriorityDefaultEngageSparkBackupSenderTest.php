 ...
 */
class SemaphorePriorityDefaultEngageSparkBackupSenderTest extends \PHPUnit_Framework_TestCase
{
    private $container;
    private $kernel;
    ...
    {
        $this->kernel = new AppKernel('semaphore_priority_default_engage_spark_backup', true);
        $this->kernel->boot();
